...
<input type="hidden" name="member_id" value="<?php echo $member_id; ?>">
       ...
       <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_user" value="<?=$m_user;?>" type="text" required class="form-control" id="m_user" placeholder="Username" pattern="^[a-zA-Z0-9]+$" title="ภาษาอังกฤษหรือตัวเลขเท่านั้น" minlength="2"  />
          </div>
      </div> 
        <div class="form-group">
          <div class="col-sm-5" align="left">
